namespace Omics.Fragmentation.Peptide
{
    public class TerminusSpecificProductTypes
    {
        ...
        {
            {FragmentationTerminus.N, new List<ProductType>{ ProductType.a, ProductType.aDegree, ProductType.aStar, ProductType.aPlusOne, ProductType.b, ProductType.bWaterLoss, ProductType.bAmmoniaLoss, ProductType.c } }, //all ion types that include the N-terminus
            {FragmentationTerminus.C, new List<ProductType>{ ProductType.x, ProductType.y, ProductType.yWaterLoss, ProductType.yAmmoniaLoss, ProductType.yMinusTwo, ProductType.yMinus2AmmoniaLoss, ProductType.zDot, ProductType.zPlusOne } }, //all ion types that include the C-terminus
            {FragmentationTerminus.Both, new List<ProductType>{ ProductType.a, ProductType.aDegree, ProductType.aStar, ProductType.aPlusOne, ProductType.b, ProductType.bWaterLoss, ProductType.bAmmoniaLoss, ProductType.c, ProductType.x, ProductType.y, ProductType.yWaterLoss, ProductType.yAmmoniaLoss, ProductType.yMinusTwo, ProductType.yMinus2AmmoniaLoss, ProductType.zDot, ProductType.zPlusOne} },
        ...
        public static Dictionary<ProductType, FragmentationTerminus> ProductTypeToFragmentationTerminus = new Dictionary<ProductType, FragmentationTerminus>
        {
            ...
            { ProductType.aPlusOne, FragmentationTerminus.N },
            ...
            { ProductType.yMinusTwo, FragmentationTerminus.C },
            { ProductType.yMinus2AmmoniaLoss, FragmentationTerminus.C },
